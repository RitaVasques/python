...
class ClienteDAO:
    ...
    def insertar(cls, cliente):
        ...
        try:
            ...
            conexion.commit()
            return cursor.rowcount #cuantos valores se modificaram na base de dados
        except Exception as e:
    ...
    def eliminar(cls, cliente):
        ...
        try:
            conexion = Conexion.obtener_conexion()
            cursor = conexion.cursor()
            valores = (cliente.id,) # , al final para que sea una tupla
    ...
    # Insertar cliente
    #cliente1 = Cliente(nombre='Alejandra', apellido='Flores', membresia=300)
    #clientes_insertados = ClienteDAO.insertar(cliente1)
    #print(f'Clientes insertados: {clientes_insertados}')

    # Actualizar cliente
    #cliente_actualizar = Cliente(3, 'Alexa', 'Flores', 400)
